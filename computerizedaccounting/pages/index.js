  ...
  return (
    <>
      ...
      <BaseCard>
        ...
        {assets.length > 0 ||
        contraassets.length > 0 ||
        liabilities.length > 0 ||
        ownersequities.length > 0 ||
        revenues.length > 0 ||
        expenses.length > 0 ||
        ownersdrawings.length > 0 ? (
          <Button
        ...
        >
          ...
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Are you sure you want to delete all accounts? All of your data
              regarding accounts will be permanently removed. This action cannot
              be undone.
            </DialogContentText>
          </DialogContent>
          <DialogActions>
